class Polygon {
  ...
  containsPoint(point) {
    // this is used to calculate if point is inside the polygon
    // we look for odd number of intersections
    // even number of intersections would mean we are outside of polygon
    // define a point outside of canvas and check how many times this point crosses the polygon
